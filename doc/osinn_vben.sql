...
CREATE TABLE `tbl_sys_config` (
  ...
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '状态 1正常；2-禁用',
  `is_default` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否系统默认账号1-默认，2-非默认',
  `is_deleted` tinyint(1) NOT NULL DEFAULT '0' COMMENT '删除标记 0-存在；1-删除',
...
INSERT INTO `tbl_sys_config` (`id`, `config_group_name`, `config_name`, `config_key`, `config_value`, `remarks`, `status`, `is_default`, `is_deleted`, `created_by`, `created_time`, `updated_by`, `updated_time`) VALUES (3127412782383853574, '默认', 'demo', 'vn', '11', 'as', 2, 2, 0, 1401043674048851970, '2026-01-16 06:25:30', 1401043674048851970, '2026-01-16 08:37:40');
COMMIT;
...
CREATE TABLE `tbl_sys_user` (
  ...
  `sort` int(11) NOT NULL DEFAULT '0' COMMENT '排序',
  `remarks` varchar(512) DEFAULT NULL COMMENT '备注',
  `status` tinyint(1) DEFAULT '0' COMMENT '状态1正常；2停用',
  `is_default` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否系统默认账号，1-默认，2-非默认',
  `is_deleted` tinyint(1) NOT NULL DEFAULT '0' COMMENT '删除标记 0-存在；1-删除',
  `created_by` bigint(20) DEFAULT NULL COMMENT '创建人',
  `created_time` datetime DEFAULT NULL COMMENT '创建时间',
  `updated_by` bigint(20) DEFAULT NULL COMMENT '更新人',
