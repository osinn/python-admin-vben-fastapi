...
"""
# 数据库
SQLALCHEMY_DATABASE_URL = "mysql+asyncmy://root:123456@192.168.1.50:3306/osinn_vben"
# 任务调度连接数据库地址
APSCHEDULER_DATABASE_URL = "mysql+pymysql://root:123456@192.168.1.50:3306/osinn_vben?charset=utf8"
