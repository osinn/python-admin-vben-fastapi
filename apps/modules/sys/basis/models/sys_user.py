...
class SysUserModel(BaseEntity):
    ...
    psw_modified: Mapped[bool] = mapped_column(Boolean, nullable=False, server_default="0", comment="修改密码标记 0未修改；1已修改")
    ...
    status: Mapped[bool] = mapped_column(Boolean, comment="状态 0正常；1停用", server_default="0")
    is_default: Mapped[bool] = mapped_column(Boolean, nullable=False, comment="是否系统默认账号", server_default="0")
