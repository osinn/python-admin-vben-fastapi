...
class JobSchedulerModel(BaseEntity):
    ...
    job_group_id: Mapped[int] = mapped_column(BIGINT, nullable=False, comment="任务组ID")
    job_key: Mapped[str] = mapped_column(String(100), nullable=False, comment="任务key唯一标识")
    ...
    remarks: Mapped[str] = mapped_column(String(255), nullable=False, comment="备注")
